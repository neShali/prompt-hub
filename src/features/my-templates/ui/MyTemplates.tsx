    ...
    <section>
      ...
      <div className={styles.header}>
        <div>
          ...
          <h1>Мои шаблоны</h1>
          <p>
            Созданные шаблоны сохраняются в localStorage браузера. На следующем
            этапе эти сценарии будут покрыты тестами.
          </p>
        </div>
      ...
      {templates.length === 0 ? (
        <div className={styles.emptyState}>
          ...
          <p>Создайте первый шаблон, чтобы проверить форму, валидацию и сохранение.</p>
          <Link className="primaryLink" href="/profile/templates/new">
            Перейти к созданию
          </Link>
        </div>
